[![Build Status](https://travis-ci.org/fangmobile/rails-travis-example.svg?branch=master)](https://travis-ci.org/fangmobile/rails-travis-example) [![Code Climate](https://codeclimate.com/github/secure-pipeline/rails-travis-example.png)](https://codeclimate.com/github/secure-pipeline/rails-travis-example)
